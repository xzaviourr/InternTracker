...
class Qualcomm(scrapy.Spider) :
    ...
    def start_requests(self) :
        ...
        try :
            url = 'https://qualcomm.wd5.myworkdayjobs.com/External/1/refreshFacet/318c8bb6f553100021d223d9780d30be'
    ...
    def parse(self,response) :
        ...
        try :
            ...
            for i in range(number_of_pages) :
                r = requests.get(f'https://qualcomm.wd5.myworkdayjobs.com/External/1/searchPagination/318c8bb6f553100021d223d9780d30be/{i * 50}').json()
                for j in range(50) :
                    cur = r['body']['children'][0]['children'][0]['listItems'][j]['title']['commandLink']
                    yield scrapy_splash.SplashRequest(url = f'https://qualcomm.wd5.myworkdayjobs.com{str(cur)}',callback = self.parse_post,args = {'wait' : 5})
        except Exception as e :
            career_site_logger.error(e)

...
# Create handlers
normal_site_handler = logging.FileHandler('InternTracker/Logger/normal_site_logger.log')
...
career_site_handler = logging.FileHandler('InternTracker/Logger/career_site_logger.log')
...
db_handler = logging.FileHandler('InternTracker/Logger/db_logger.log')
